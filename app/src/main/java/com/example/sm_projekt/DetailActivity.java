    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notifyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(DetailActivity.this, "My Notification");
                builder.setContentTitle("Covid-19 app");
                builder.setContentText("Don't forget to wash your hands!");
